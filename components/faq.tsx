  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "Jalan Taman Siswa, Kelapa Sawit, Padasugih, Brebes. Lokasinya dekat dengan fasilitas umum. Hanya berjarak 6 menit dari RSUD Brebes, 13 menit dari SMAN 3 Brebes, 5 menit dari Yogya Mall Brebes, 3 menit dari GOR Sasana Adhi Karsa Brebes, 5 menit dari Stasiun Brebes, dan 9 menit dari Pusat Pemerintahan Kabupaten Brebes.",
    },
    {
      question: "Apa saja fasilitas umum yang disediakan di dalam Sapphire Aesthetic Brebes?",
      answer:
        "Di Sapphire Aesthetic Brebes, kami menghadirkan lingkungan dengan fasilitas modern dan nyaman. Kami menyediakan fasilitas olahraga di sekitar area perumahan. Selain itu, kami juga menyediakan area terbuka hijau atau green area yang memberikan kesejukan dan ketenangan sehingga cocok digunakan untuk tempat rekreasi Anda. Kami juga mengutamakan keamanan dengan one gate system dan CCTV yang aktif 24 jam untuk menjaga kawasan tetap aman.",
    },
    {
      question: "Apakah rumah di Sapphire Aesthetic Brebes sudah memiliki sertifikat hak milik (SHM)?",
      answer:
        "Di Sapphire Aesthetic Brebes, kami sudah mengurus proses pemecahan sertifikat, jadi saat serah terima nanti, sertifikatnya langsung atas nama Bapak/Ibu. Hal ini mempermudah dan mempercepat proses kepemilikan tanpa perlu menunggu lama untuk pengurusan balik nama. Kami memastikan urusan administrasi menjadi lebih praktis untuk Bapak/Ibu, jadi begitu Anda menerima kunci, status kepemilikan sudah resmi atas nama Anda.",
    },
    {
      question: "Apakah sertifikat ini aman dari masalah hukum di kemudian hari?",
      answer:
        "Mengenai legalitas di Sapphire Aesthetic Brebes, semua sudah lengkap dan aman, Bapak/Ibu. Properti di sini dilengkapi Sertifikat Hak Milik (SHM), jadi kepemilikannya jelas atas nama pembeli. Izin bangunannya juga sudah ada melalui Persetujuan Bangunan Gedung (PBG), artinya bangunan sudah sesuai aturan dan aman.",
    },
    {
    ...
    {
      question: "Apakah rumah di Sapphire Aesthetic Brebes sudah memiliki PBG?",
      answer:
        "Rumah di Sapphire Aesthetic Brebes sudah memiliki Persetujuan Bangunan Gedung (PBG), jadi Anda tidak perlu khawatir soal legalitas bangunan ini. PBG ini memastikan bahwa proses pembangunan sudah sesuai dengan peraturan yang berlaku, sehingga hunian di sini aman dan sah untuk ditinggali, maupun sebagai investasi jangka panjang.",
    },
    {
    ...
    <section id="faq" className="faq-section">
      <div className="container">
        <div className="faq-header">
          <h2 className="faq-title">Pertanyaan Umum Sapphire Aesthetic Brebes</h2>
