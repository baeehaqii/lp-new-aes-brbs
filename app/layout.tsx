...
export const metadata: Metadata = {
  title: "Sapphire Aesthetic Brebes - Hunian Modern di Brebes",
  description: "Temukan properti impian Anda di Sapphire Aesthetic Brebes, hunian modern dengan lokasi strategis di Jl. Taman Siswa, Klp. Sawit, Padasugih, Kec. Brebes dengan fasilitas lengkap dan Smart Door Lock",
  icons: {
